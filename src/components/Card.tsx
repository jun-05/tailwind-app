...
const Card = () => {
  return (
    <div>
      <div className=" flex w-full  md:max-w-md items-center dark:bg-gray-900 py-6 px-4 justify-center ">
        <div>
          <div className="max-w-xs h-64 md:h-fit flex flex-col justify-between bg-white dark:bg-gray-800 rounded-lg border border-gray-400  py-5 px-4">
            <div>
